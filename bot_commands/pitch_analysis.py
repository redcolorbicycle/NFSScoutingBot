...
class RankedPitchStats(commands.Cog):
    ...
    async def cog_check(self, ctx):
        allowed_user_ids = [
            ...
            308760445160783882, 788709027570778123, 789922571834884107, 1062838877527756980, 812515320664162324, 703051352141725810, 807822868020199435, 1150787076581752913, 1155995827102302218, 911330343741702194, 693621768853782569, 976439679903748096
        ]
