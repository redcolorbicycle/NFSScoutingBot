                ...
                try:
                    ...
                    cursor.execute(
                        ...
                        ON CONFLICT (Name) DO UPDATE SET
                            ...
                            SP1_name = CASE WHEN EXCLUDED.SP1_name <> NULL THEN EXCLUDED.SP1_name ELSE Player.SP1_name END,
                            SP1_skills = CASE WHEN EXCLUDED.SP1_skills <> NULL THEN EXCLUDED.SP1_skills ELSE Player.SP1_skills END,
                            SP2_name = CASE WHEN EXCLUDED.SP2_name <> NULL THEN EXCLUDED.SP2_name ELSE Player.SP2_name END,
                            SP2_skills = CASE WHEN EXCLUDED.SP2_skills <> NULL THEN EXCLUDED.SP2_skills ELSE Player.SP2_skills END,
                            SP3_name = CASE WHEN EXCLUDED.SP3_name <> NULL THEN EXCLUDED.SP3_name ELSE Player.SP3_name END,
                            SP3_skills = CASE WHEN EXCLUDED.SP3_skills <> NULL THEN EXCLUDED.SP3_skills ELSE Player.SP3_skills END,
                            SP4_name = CASE WHEN EXCLUDED.SP4_name <> NULL THEN EXCLUDED.SP4_name ELSE Player.SP4_name END,
                            SP4_skills = CASE WHEN EXCLUDED.SP4_skills <> NULL THEN EXCLUDED.SP4_skills ELSE Player.SP4_skills END,
                            SP5_name = CASE WHEN EXCLUDED.SP5_name <> NULL THEN EXCLUDED.SP5_name ELSE Player.SP5_name END,
                            SP5_skills = CASE WHEN EXCLUDED.SP5_skills <> NULL THEN EXCLUDED.SP5_skills ELSE Player.SP5_skills END,
                            Nerf = CASE WHEN EXCLUDED.Nerf <> NULL THEN EXCLUDED.Nerf ELSE Player.Nerf END,
                            PR = CASE WHEN EXCLUDED.PR <> 9999 THEN EXCLUDED.PR ELSE Player.PR END,
                            team_name = CASE WHEN EXCLUDED.team_name <> NULL THEN EXCLUDED.team_name ELSE Player.team_name END,
